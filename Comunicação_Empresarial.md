...
## 🧩 Semiótica e Signos
- **Naturais**: nuvens negras → chuva.  
- **Artificiais**: sinais de trânsito, apitos, linguagem.  
  ...
  root((📡 Comunicação Empresarial))
    ...
    Semiótica 🧩
      ...
      Signos Naturais 🌱
        ...
        Aves → mau agouro
        Sintomas → doença
      Signos Artificiais 🛠️
        Apito de juiz
        Sinal de trânsito
        Linguagem escrita/falada
      Diferença ✨
        Naturais = espontâneos
        Artificiais = intencionais
    Percepção 👀
      Atitudes
      Motivação
      Interesses
